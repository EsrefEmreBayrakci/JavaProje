...
public class AddStudent extends JFrame {
	...
	public AddStudent() {
		...
		JLabel lblAddAccountant = new JLabel("Öğrenci Ekle");
		...
		JButton btnAddAccountant = new JButton("Öğrenci Ekle");
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status>0){
					JOptionPane.showMessageDialog(AddStudent.this,"Başarılı!");
					...
					JOptionPane.showMessageDialog(AddStudent.this,"Hata!");
				}
			}
		});
