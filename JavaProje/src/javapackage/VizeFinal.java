...
public class VizeFinal extends JFrame {
	static VizeFinal frame;
	public VizeFinal() {
		...
		for(Student s:list){
			...
			data[row][4]=String.valueOf(s.getVize());
			data[row][5]=String.valueOf(s.getFinall());
			data[row][6]=String.valueOf(s.getProje());
