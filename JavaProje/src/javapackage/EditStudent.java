...
public class EditStudent extends JFrame {
	...
	public EditStudent() {
		...
		JLabel lblFee = new JLabel("Vize:");
		
		JLabel lblPaid = new JLabel("Final:");
		
		JLabel lblDue = new JLabel("Proje:");
		
		JLabel lblAddress = new JLabel("Adres:");
		
		JLabel lblCity = new JLabel("Şehir:");
		
		JLabel lblState = new JLabel("İlçe:");
		
		JLabel lblCountry = new JLabel("Ülke:");
		
		JLabel lblContactNo = new JLabel("İletişim No:");
		
		JButton btnAddAccountant = new JButton("Öğrenci Güncelle");
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status>0){
					JOptionPane.showMessageDialog(EditStudent.this,"Başarılı!");
					AccountantSection.main(new String[]{});
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(EditStudent.this,"Hata");
				}
			}
		});
		...
		JButton btnLoadRecord = new JButton("Öğrenci Yükle");
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(srollno==null||srollno.trim().equals("")){
					JOptionPane.showMessageDialog(EditStudent.this,"Lütfen önce ID giriniz");
				}else{
				...
				textField_3.setText(String.valueOf(s.getVize()));
				textField_4.setText(String.valueOf(s.getFinall()));
				textField_5.setText(String.valueOf(s.getProje()));
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblFee, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblPaid, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblDue, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
