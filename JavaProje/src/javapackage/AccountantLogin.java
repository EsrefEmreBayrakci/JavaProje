...
public class AccountantLogin extends JFrame {
	...
	public AccountantLogin() {
		...
		JLabel lblAccountantLogin = new JLabel("Oğretmen Giriş");
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(status){
				...
				JOptionPane.showMessageDialog(AccountantLogin.this,"Gecersiz kullanıcı adı ve şifre ","Giriş Hatası!",JOptionPane.ERROR_MESSAGE);
			}
			}
		});
