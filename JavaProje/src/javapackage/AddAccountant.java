...
public class AddAccountant extends JFrame {
	...
	public AddAccountant() {
		...
		JLabel lblAddAccountant = new JLabel("Öğretmen Ekle");
		...
		JButton btnAddAccountant = new JButton("Öğretmen Ekle");
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status>0){
					JOptionPane.showMessageDialog(AddAccountant.this,"Başarılı!");
					textField.setText("");textField_1.setText("");textField_2.setText("");
					passwordField.setText("");
				}else{
					JOptionPane.showMessageDialog(AddAccountant.this,"Hata!");
				}
			}
		});
