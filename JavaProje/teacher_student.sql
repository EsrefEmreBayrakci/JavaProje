...
CREATE TABLE `feereport_student` (
  ...
  `state` varchar(200) CHARACTER SET latin1 NOT NULL,
  `country` varchar(100) CHARACTER SET latin1 NOT NULL,
  `contactno` varchar(20) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `feereport_student` VALUES (6,'Azim Cagri Unal','azim_unal@outlook.com','Bilgisayar Mühendisligi',75,100,100,'Angara','Ankara','Merkez','Türkiye','0','2023-01-03 12:56:06'),(7,'Esref Emre','emrememre@gmail.com','Bilgisayar Muh',95,100,100,'Ankara','Ankara','Sincan','Türkiye','01','2023-01-03 12:57:02');
...
-- Dump completed on 2023-01-03 16:20:31
